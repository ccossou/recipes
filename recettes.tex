...
\etape Entaillez le gras du magret (quadrillez) puis salez des deux cotés juste avant de cuire
\end{preparation}

\begin{cuisson}
\begin{itemize}
\item Faites chauffer la poêle (antiadhésive c'est mieux, poêle acier, c'est trop chaud, et c'est pas cuit à l'intérieur) à feu vif (6/9) (ne pas faire plus chaud, pour les mêmes raisons que la poêle acier)
\item Faites cuire le magret coté peau à feu vif (6/9) 1min30 à 2 minutes de chaque coté (En appuyant dessus, il doit encore être moelleux).

Plus le magret est gros, et moins le feu doit être vif, pour qu'il y ait le temps de faire cuire l'intérieur. Pour un magret assez petit, ça doit être vif (7/9) pendant moins d'1min30s de chaque coté. Pour plus gros, 1min45s à 6/9 par exemple 
...
\section{Saucisse de toulouse}
\begin{recette}{Saucisse de toulouse}{4}{15 min}{30 min}\index{saucisse}
\begin{ingredients}
\ingredient Saucisse de toulouse
\end{ingredients}

\begin{preparation}
\etape Préchauffez le four ou l'air fryer pour un temps de cuisson plus précis
\etape dans l'air fryer ou four, mettez dans un récipient pour avoir moins de vaisselle
\etape Ne piquez pas la saucisse
\etape ne la sortez pas du frigo à l'avance non plus
\end{preparation}
...
\hline 
Mode de cuisson & Température & Durée de cuisson de chaque coté & Commentaires \\ 
\hline 
four & 275°C & 5 minutes & en grill, porte entrebaillée\\ 
\hline 
Air Fryer & 200°C & 3min30s & 4 minutes si l'air fryer est froid au début\\\hline
Barbecue & feu vif/très vif & 5 minutes & \\\hline
\end{tabular}

Note: Pour moyenne saucisse (2.4cm de diamètre), C'est 3 minutes à l'air fryer de chaque coté.

Petite saucisse (chipolata)

\begin{tabular}{|c|c|c|c|}
\hline 
Mode de cuisson & Température & Durée de cuisson de chaque coté & Commentaires \\ 
\hline 
four & 275°C & 5 minutes puis 2min30s de l'autre coté & en grill, porte entrebaillée \\ 
\hline 
Air Fryer & 200°C & ? & \\\hline
Barbecue & feu vif/très vif & ? & \\\hline
\end{tabular} 
...
% 2e fois: 50cl de crème fraiche c'était trop, gout de crème. Je sais plus si la première fois on avait pris liquide ou fraiche
...
\ingredient 5 câpres
\ingredient 1 gousse d'ail
\ingredient 7cl d'huile d'olive
\end{ingredients}
...
\begin{ingredients}
\ingredient 200g d'huile
\ingredient 100 de vinaigre balsamique (6° d'acidité)
\ingredient 60g d'eau (permet une vinaigrette moins solide) % 70g c'était trop, vinaigrette pas assez acide)
\ingredient 7.5g de sel % 2% de sel en masse par rapport au poids total
...
``solide'', mais maintenant je met de l'eau en plus pour avoir quelque chose de moins visqueux. 
\end{remarque}


\begin{preparation}
\etape Dans un contenant, par exemple une bouteille, placez un entonnoir et placez le tout sur une balance. Ce n'est pas la technique classique pour une vinaigrette, mais elle est rapide pour en faire en quantité, et comme il faut refaire l'émulsion avant chaque utilisation, ça ne change pas grande chose
\etape Ajoutez d'abord le sel (et les ingrédients sec, tant que l'entonnoir n'est pas mouillé)
\etape Ajoutez à cette étape tous les autres ingrédients (herbes, ail,...) que vous voulez y mettre
\etape Ajoutez alors l'huile pour faire tomber les grains de sel qui sont resté sur l'entonnoir
\etape Ajoutez le vinaigre pour laver un peu l'entonnoir de l'huile qui y colle
\etape Ajoutez enfin l'eau afin de nettoyer le tout au mieux (ça facilite la vaisselle et minimise les ingrédients qui restent sur l'entonnoir.
\etape Fermez alors la bouteille et secouez pour homogénéiser.
\end{preparation}
\end{recette}
...
\begin{ingredients}
\ingredient 40g d'ail ($\sim 7$ gousses)
\ingredient 300g d'huile de tournesol
\ingredient 8g de sel
\ingredient 23g de moutarde
\ingredient 20g de vinaigre de citron
\ingredient 77g d'eau
...
%recette melina
\section{Roulés jambon/fromage}
\begin{recette}{Roulés jambon/fromage}{3}{20 min. + 1h + 5min. + 3h}{20 min.}\index{pâte feuilletée}
\begin{ingredients}[15 petits roulés]
\ingredient Une pâte feuilleté (ne pas la sortir à l'avance)
\ingredient 2 tranchdes de jambon
\ingredient fromage rapé
\ingredient 3 cas de crème semi épaisse
\end{ingredients}

\begin{preparation}
\etape Dérouler la pâte
\etape Déposer quasiment au centre les deux tranches de jambon
\etape puis y badigeonner la crème
\etape ajouter le fromage rapé
\etape rouler le tout pour faire un gros boudin
\etape mettre 15 minutes au congélateur pour faciliter la découpe
\etape découper des tranches de 1.5cm environ
\end{preparation}
...
\section{viande demi sel}
\begin{recette}{viande demi sel}{}{20 min}{3 jours}\index{porc}
\begin{ingredients}
\ingredient viande de porc fraiche (par exemple roti dans l'échine)
\ingredient 30g de sel / kg (eau incluse)
\end{ingredients}

\begin{preparation}
\etape Coupez la viande en morceaux grossiers (cubes de 5cm)
\etape Recouvrer d'eau et pesez le tout
\etape Calculer la quantité de sel pour la masse totale (viande + marinade)
\etape Laissez mariner 3 jours environ (comptez 24h par cm, donc ici 24 x 2.5cm)
\end{preparation}
\end{recette}
...
Autres infos:
\begin{itemize}
\item La fermentation est maximale autour de 30° C
\item Les levures meurent rapidement à partir de 47° C
\item La fermentation est généralement faite à 24-25°C (25 pour la recette de baguette tradition que j'ai vue)
\end{itemize}
...
\begin{enumerate}
\item Frasage: mélange des ingrédients qui composent la pâte à pain.
\item Autolyse: permet d'hydrater la farine
\item Bassinage: rajouter de l'eau en fin de frasage pour hydrater encore plus la pâte après la formation des réseaux de gluten
\item Pointage: première fermentation, la formation de bulle importe peu, c'est la fermentation alcoolique qui domine
\item Rabattage: permet d'incorporer des bulles d'air dans la pâte (ceci joue beaucoup sur la levée finale)
\item Blocage: mise au frais pour bloquer la fermentation et reprendre le lendemain
\item Boulage: mise en forme
\item Détente: 
\item Façonnage: étape de repos qui permet au réseau de gluten de se détendre, faute de quoi il pourrait se déchirer lors du façonnage.
\item Apprêt: seconde fermentation de la pâte, où les bulles se forment
\end{enumerate}
...
\etape Diluez la levure dans l'eau légèrement tiède. Ajoutez une cuillère à soupe de farine et un peu de sucre puis laissez reposer 15 minutes
...
Avant d'enfourner, dorez les brioches avec le reste d'œuf du début de recette. 
...
\begin{cuisson}
Préchauffez le four pendant 10 minutes à 220°C avec un lèche frite en bas.
...
Mettez alors le four à 220°C pendant 25 minutes à chaleur tournante.
...
\ingredient 11g de sel % avant 9g, mais la baguette pro était encore plus salée que mon 11g. En théorie, 13 quand je fais le prorata de la baguette rapide
\end{ingredients}
...
\etape Faites alors deux boules individuelles (de 285g normalement).
...
\item il faut que les fruits apportent suffisamment de pectine (ou en ajouter par ailleurs)
\item la quantité de sucre doit être assez importante pour favoriser l'association de pectine. L'ordre de grandeur c'est 1kg de sucre pour 1kg de fruit si sucre normal, et 650g si sucre à confiture (car il est additionné de pectine). 
\item Mariner les fruits dans le sucre et l'acidité permet à la pectine d'être extraite plus rapidement et de permettre une cuisson plus courte.
\item il faut un peu d'acidité pour que la pectine se comporte bien. Si le fruit n'est pas acide, rajouter le jus d'un citron (compter 45g de jus de citron par kg de fruit)
\end{itemize}

Les fruits très riches en pectines : Pomme (0,5 à 1,6\%), Pelure de citron (2,5 à 4\%), Pelure d'orange (3,5 à 5,5\%)

Les fruits riches en pectines : Abricot (1\%), Prune (0,9\%), Goyave (0,8 à 1\%)

Les fruits moyennement riches en pectines : Poire (0,5\%), Mûre (0,7\%), Fraise (0,6 à 0,7\%)

Les fruits pauvres en pectines : Cerise (0,3\%), Pêche (0,1 à 0,5\%), Mangue (0,25 à 0,45\%), Tomate (0,2 à 0,6\%),Cassis (0,1\%)

\begin{remarque}
Si vous n'ajoutez pas assez de sucre, elle devra cuire (et réduire plus longtemps) pour faire la perle (105°C), et à ce moment là, vous aurez le même ratio de sucre, c'est simplement que vous aurez trop cuit les fruits et perdu tout le parfum. Pour utiliser moins de sucre, il faut plus de pectine ou un gélifiant afin de compenser.
\end{remarque}
...
\begin{ingredients}[8 pots]
\ingredient 1.5kg de mangue (juste la pulpe, sans peau ni noyau)
\ingredient 200g de pulpe de fruit de la passion avec pépins (ou 150g sans pépins)
\ingredient 1.5kg de sucre
\end{ingredients}

\begin{remarque}
les mangues étant pauvres en pectines, il faut mariner longtemps dans le sucre et l'acide pour bien l'extraire. On peut aussi rajouter de la pectine à part. A noter que le sucre à confiture avec de la pectine, 1kg suffit, 10 minutes de marinade, puis 8 minutes à ébullition suffisent.
\end{remarque}

\begin{preparation}
\etape Mixez la pulpe de mangue pour éliminer les fibres
\etape Mixez alors la pulpe de fruit de la passion, puis filtrez à la passoire pour éliminer les pépins
\etape Dans un chaudron assez grand pour contenir tous les ingredients, mettez les deux pulpes et le sucre.
\etape Laissez mariner à couvert pendant plusieurs heures
\end{preparation}
...
\item Poursuivre la cuisson pendant environ 20 minutes (5-8 minutes si sucre à confiture)
\item Verser dans des pots stérilisés (mettez beaucoup de confiture, fermez puis retournez les pots).
\end{enumerate}
\end{cuisson}
\end{recette}
...
\section{Biscuits de Noel}
\begin{recette}{Biscuits de Noel}{3}{4h}{10 min.}\index{Noel}
% recette Diana: https://www.bredele.fr/etoiles-a-la-cannelle
\begin{ingredients}
\ingredient[Pâte]
\ingredient 250g de sucre glace
\ingredient 2 cac cannelle en poudre
\ingredient 250g d'amande en poudre
\ingredient 2 blancs d'oeufs
\ingredient[glaçage]
\ingredient 1/2 blanc d'oeuf (peser et prendre la moitié)
\ingredient 80g de sucre glace
\end{ingredients}

\begin{preparation}
\etape Montez les blancs en neige
\etape Ajoutez le sucre et la cannelle
\etape Ajoutez enfin la poudre d'amande, afin que le mélange soit bien homogène
\etape Réservez au frais, une moitié dans deux bols séparés (pour que ça refroidisse mieux et faire des rotations afin d'avoir la pâte toujours fraiche)
\etape Battre le blanc d'oeuf et le sucre pour le glaçage
\etape Découpez les étoiles à l'aide d'un emporte-pièce fariné tout en faisant des rotations avec les deux bols de pâte dès qu'un des deux recommence à accrocher et disposez les sur une plaque à patisserie recouverte de papier cuisson
\etape Etalez une fine couche de glaçage sur les biscuits
\etape Laissez saicher environ 2h à température ambiante et à l'abris des courants d'air.
\end{preparation}

\begin{cuisson}
Préchauffez le four à 170°C. Faites cuire pendant 10 minutes.
\end{cuisson}
\end{recette}
...
\section{Zézettes de Sète}
\begin{recette}{Zézettes de Sète}{0}{20 min.+1h}{25 min.}\index{biscuit}\index{orange confite}\index{zezette}

\begin{ingredients}[15 biscuits]
\ingredient 275 g Farine tamisée
\ingredient 75 g Sucre en poudre
\ingredient 75g Muscat de Frontignan (ou vin blanc)
\ingredient 75g d'huile
\ingredient 1 c. à soupe Fleur d'oranger
\ingredient 1 c. à café Extrait de vanille
\ingredient 5.5g Levure chimique (1/2 sachet)
\ingredient 150g de zeste d'orange confite émincés en petits cube de 3mm de coté
\end{ingredients}


\begin{preparation}
\etape Préchauffez le four à 180° en chaleur tournante.
\etape Dans un saladier, mélangez le sucre en poudre, la farine et la levure
\etape Ajoutez le muscat, la fleur d'oranger, l'huile et la vanille puis bien mélanger le tout.
\etape Faire une saucisse, la filmer et la mettre au frigo 1 heure.
\etape Après on fait des petits morceaux; on les tord, il faut bien les séparer afin qu'ils ne se collent pas entre eux (au besoin rajouter un peu de farine).
\begin{remarque}
Comptez environ 1cm de diamètre et 7cm de long. L'ordre de grandeur c'est 11g de pâte %source: https://lacuisinedebernard.com/zezettes-de-sete/
\end{remarque}
\etape Avant de les mettre sur la plaque de cuisson les rouler dans du sucre en poudre
\etape Enfournez pour 25 minutes de cuisson jusqu'à ce que les biscuits soient bien dorés.
\end{preparation}
\end{recette}
...
\section{Jus de maracudja}
\begin{recette}{Jus de maracudja}{0}{20 min.}{}\index{maracudja}\index{fruit de la passion}

\begin{ingredients}
\ingredient 290g de pulpe de maracudja
\ingredient 122g de sucre en poudre
\ingredient 1.2L d'eau
\end{ingredients}

\begin{preparation}
\etape Mélangez la pulpe, le sucre et la moitié de l'eau
\etape Mixez et filtrez pour enlever les morceaux de pépins.
\etape Versez dans une bouteille et complétez pour faire 1.5L de jus. 
\end{preparation}
\end{recette}

\section{Grog}
\begin{recette}{Grog}{0}{20 min.}{}\index{grog}

\begin{ingredients}
\ingredient 250g d'eau
\ingredient 1 baton de cannelle
\ingredient 10g de jus de citron
\ingredient 30g de miel (une cac bombée)
\ingredient 10g de rhum blanc
\end{ingredients}

\begin{preparation}
\etape Faites bouillir l'eau avec le baton de canelle (je fais bouillir plus que prévu et je ne verse que le nécessaire

\etape Versez l'eau chaude dans le reste des ingrédients déjà posés dans un mug puis mélangez et laissez refroidir un peu avant de boire. 
\end{preparation}
\end{recette}
...
\subsection{Peler de l'ail (en grande quantité)}\label{sec:peler_ail}\index{ail}
