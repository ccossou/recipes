...
\begin{itemize}
 ...
 \item pour de la saucisse diamètre 2.4cm: 3min30s de chaque coté (4 minutes si l'air fryer est froid au début), c'était une grosse saucisse plus fine que d'habitude.
\end{itemize}

A l'air fryer à 200°C
\begin{itemize}
 \item Pour de la grosse saucisse: 3 min30s de chaque coté
 \item pour de la saucisse diamètre 2.4cm: 3min de chaque coté, c'était une grosse saucisse plus fine que d'habitude. (3min30s si l'air fryer est froid au début)
\end{itemize}
