...
\hline 
\textbf{Bassinage}  & \multicolumn{2}{M{12cm}|}{Ajoutez l'eau de bassinage en filet pendant que vous pétrissez pendant 2 minutes à vitesse 2 (laissez bien l'eau absorber avant d'en rajouter pour ne pas casser les réseaux de gluten).} \\ 
\hline 
\textbf{Pointage} & \multicolumn{2}{M{12cm}|}{Laissez la pâte reposer pendant 1h (je met une plaque de verre sur le bol du robot)} \\ 
\hline
\textbf{Blocage} & - & Mettez au frigo, couvert, pendant 12 à 14h à 4°C \\
\hline
\textbf{Rabattage} & Effectuez un rabattage et laissez pointer 1h de plus. & Le lendemain, à l'aide d'une spatule silicone, décollez la pâte et versez la sur un plan de travail fariné. Effectuez un nouveau rabattage tant que la pâte est froide, ce coup ci de façon classique en étalant la pâte puis en ramenant les coins au centre. \\
\hline 
 & \multicolumn{2}{M{12cm}|}{Découpez 4 morceaux égaux en volume} \\ 
\hline 
