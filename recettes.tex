...
\etape Entaillez le gras du magret (quadrillez) puis frottez avec un peu de gros sel des deux cotés juste avant de cuire
\end{preparation}

\begin{cuisson}
\begin{itemize}
\item Faites chauffer la poêle à feu vif (6/9)
...
\begin{ingredients}
\ingredient 60g d'ail ($\sim 10$ gousses)
