...
\begin{preparation}
\etape Préchauffez le four à 200°C chaleur tournante
...
\begin{attention}
La cuisson n'est pas satisfaisante jusqu'à présent. Il faut faire cuire à feu très vif et pendant pas trop longtemps pour que ce soit bon je pense. 

20 minutes à 220°C, c'était trop pour de la grosse saucisse la dernière fois. Peut-être 10-15 minutes. Je fais à la poele ou au barbecue maintenant, et ça n'interfère pas avec les pommes de terre au four comme ça.
\end{attention}

\begin{itemize}
 \item Pour de la saucisse fine: ? minutes à ?°C
 \item Pour de la grosse saucisse: ? minutes à ?°C (29 minutes à 180°C c'était pas mal mais il faut plus chaud et moins longtemps je pense)
\end{itemize}
...
\ingredient quelques gouttes de vinaigre
\ingredient sel
\end{ingredients}
...
\ingredient 180 mL de vinaigre de citron
\ingredient 1 cuillère à soupe bombée de moutarde
...
% Vinegar: 25.25 g
% Water: 22.0 g
\begin{ingredients}[40mL de vinaigrette]
...
\ingredient 6g de paprika
\ingredient 2g celeri
\ingredient 2g curcuma
\ingredient 4g d'ail en poudre
\ingredient 8g poudre d'oignon
...
\begin{ingredients}
\ingredient 100g de piment fort Guadeloupéen
\ingredient 2 oignons
...
\end{remarque}
\etape Mixez ça avec les oignons et le reste. 
...
\begin{recette}{Patés à la viande}{4}{20 min.}{30 min.}\index{chair à saucisse}
...
\begin{recette}{Roulés au Roquefort}{3}{20 min. + 1h + 5min. + 3h}{20 min.}\index{bleu}\index{roquefort}\index{roulés au roquefort}
...
\begin{recette}{Tarte aux champignons}{4}{20 min.}{30 min.}\index{champignons}
\begin{ingredients}
...
\begin{recette}{Tarte aux poireaux}{4}{20 min.}{30 min.}\index{poireaux}
\begin{ingredients}
\ingredient Une pâte feuilleté
...
\begin{preparation}
\etape Salez copieusement le magret sur les deux faces , disposez un lit de sel dans un plat, le magret coté chair, puis recouvrez de sel jusqu'à hauteur de graisse incluse. 
...
\begin{preparation}
\etape La veille au soir, la farine et le sel dans un bol de robot.
\etape Dans un bol, délayez la levure dans l'eau tiède
\etape Versez alors l'eau dans la farine sans faire de puit
\etape \textbf{Frasage} Pétrissez pendant 5 minutes à vitesse 1
\etape \textbf{Autolyse} Laissez reposer 1h
\etape Pétrissez pendant 10 minutes à vitesse 1
\etape \textbf{Bassinage} Ajoutez l'eau de bassinage en filet pendant que vous pétrissez pendant 2 minutes à vitesse 2 (laissez bien l'eau absorber avant d'en rajouter pour ne pas casser les réseaux de gluten).
\etape \textbf{Pointage} laissez la pâte reposer pendant 1h (je met une plaque de verre sur le bol du robot)
% la mie n'était pas parfaitement développée, peut-être qu'elle avait trop de force et qu'il faudrait rabattre un peu moins.  J'ai donc temporairement désactivé cette étape puisque je fais aussi un rabattage le lendemain matin quand la pâte est plus froide.
%\etape \textbf{Rabatage} Rabattez la pâte. Comme elle est trop liquide, faites des rabattages dans le bol du robot, à l'aide d'une spatule en silicone, en prenant un bord et en passant par dessus la pâte pour l'emmener de l'autre coté. Répétez l'opération une vingtaine de fois. 

\etape \textbf{Blocage} Mettez au frigo, couvert, pendant 12 à 14h à 4°C
\etape \textbf{Rabatage} Le lendemain, à l'aide d'une spatule silicone, décollez la pâte et versez la sur un plan de travail fariné. Effectuez un nouveau rabattage tant que la pâte est froide, ce coup ci de façon classique en étalant la pâte puis en ramenant les coins au centre.

\etape \textbf{Détente} Découpez 4 morceaux égaux en volume. Laissez-les reposer 1h
\etape \textbf{Façonnage} Déposez une couche de farine sur le moule à baguette à l'aide d'une passoire fine.
\begin{remarque}
...
% en mettant 16 minutes à 250°C, c'était trop cuit sur le dessus, donc je vais baisser à 240.
...
\section{Pain (frigo/nuit) 2 fournées}
\begin{recette}{Pain (frigo/nuit) 2 fournées}{3}{45min+10h+3h}{30 min}\index{pain}\index{levure de boulanger}
\begin{ingredients}[4 baguettes]
\ingredient 1kg de farine de blé T55
\ingredient 700mL d'eau tiède (30-35°C)
\ingredient 15 mL d'eau de bassinage (encore en train d'optimiser la valeur. En mettre améliore la tenue, mais trop et c'est très difficile à manipuler)
\ingredient 7g de levure sèche
\ingredient 16g de sel 
\end{ingredients}
...
\etape Pétrissez 4 minutes à vitesse 2 tout en versant l'eau de bassinage en un mince filet. Stoppez le filet quand ça ruisselle et reprenez quand l'eau est incorporée (il ne faut pas que ça dénature la pâte)
...
\etape Toujours à l'aide d'une spatule silicone, décollez la pâte et versez la sur un plan de travail fariné (utilisez une passoire fine) . Découpez 8 
...
\begin{cuisson}
Préchauffez le four pendant 20 minutes à 240°C avec un lèche frite en bas. (Notez que les 20 minutes de préchauffe sont comprises dans le temps de la dernière montée. Au bout de l'heure, le four doit déjà être chaud)
...
Faites de même avec la 2e fournée dans la foulée, 16 minutes à chaleur tournante. 
