...
\ingredient 1/2 cuillère à café de piment
\ingredient 1 cuillère à soupe et demi de jus de citron
\ingredient 7.5cl de crème fraiche
\ingredient 1/2 cuillère à café de garam masala
\ingredient 1/2 cuillère à café de curcuma (ou pas, c'est le truc qui donne un goût de terre)
\ingredient 1 cuillère à café de cumin
...
\ingredient 1 cuillère à café de coriandre
\ingredient 1 cuillère à café de garam masala
\ingredient 1 cuillère à café de curcuma (ou pas, c'est le truc qui donne un goût de terre)
\ingredient 1 cuillère à café de piment (ou un peu moins selon les gouts)
...
\ingredient 2 cac de colombo (5g)
...
\begin{recette}{Couscous à la moi}{4}{}{}\index{couscous à la moi}\index{mouton}\index{poulet}\index{agneau}
...
\ingredient [optionnel] 1 cas de sauce Nioc Man
\end{ingredients}
...
\begin{recette}{Paëlla (à la moi)}{2}{1h10}{30 min}\index{paëlla}\index{fruits de mer}\index{chorizo}
\begin{ingredients}
...
\end{tabular}
\begin{enumerate}
\item Mesurez 900mL (voir \refsec{sec:riz} pour adapter la quantité de riz) du bouillon ainsi préparé, ajoutez de l'eau si besoin et mettez le dans la marmite où cuira la paella à la fin. Salez.
...
\etape Pendant ce temps là, émincez finement le saumon fumé (des lamelles puis des petits carrés d'environ $1\mathrm{cm^2}$.
...
\etape Mettez alors le fromage rapé. Puis saupoudrez le saumon et le fenouil sur toute la surface.
\end{preparation}

\begin{cuisson}
Faites cuire la pizza environ 10-15 minutes à 280\degres C (oui, 280).
\end{cuisson}
\end{recette}
...
\begin{recette}{Poulet à la moutarde}{5}{30 min}{50 min}\index{lapin à la moutarde}\index{moutarde}\index{lapin}\index{poulet}
