...
\item j'ai testé 2g de sel / 100g (poids total viande + marinade) fonctionne bien. Il faut laisser 48h voire plus. J'ai pas encore testé, mais thym et romarin doit être sympa dans la marinade. 
\end{itemize}
...
\section{Marinade type}
\begin{recette}{Marinade type}{4}{1h + 72h}{}\index{marinade}\index{sel}
\begin{ingredients}[2kg de viande]
\ingredient[bouillon]
\ingredient 1L d'eau
\ingredient 1 cas d'herbes de provence
\ingredient 3 feuilles de laurier
\ingredient 1 oignon
\ingredient Autre? (piment végétarien, carotte, céleri, ...)
\ingredient[marinade]
\ingredient 13.5g / kg de sel (ici 2+1kg ça donne 40.5g)
\ingredient 4g /kg de sucre (ici 2+1kg, ça donne 12g)
\ingredient 
\end{ingredients}

\begin{preparation}
\etape Mettez le bouillon à bouillir, puis laissez à ébullition environ 15 minutes (mixez les légumes avant pour que le bouillon absorbe plus vite les saveurs
\etape Laissez refroidir, voire mettez au bain marie froid pour refroidir plus vite
\etape Complétez pour avoir 1kg de bouillon (voire plus si vous faites plus de viande)
\etape Dissolvez le sel et le sucre. 
\etape Ajoutez alors la viande, mettez à couvert au frigo pendant 2.5/3 jours
\etape Le jour J, sortez la viande de la marinade, rincez sous l'eau claire, puis épongez afin que la viande soit sèche avant de cuire. 
\end{preparation}
\end{recette}
