...
\ingredient 2cl de rhum
\ingredient jus de la boite d'ananas jusqu'à avoir 22cl en tout
\ingredient eau pour compléter si besoin
\end{ingredients}
...
% marbré de stéphie, recette instagram, super bon. On peut soit zapper le cacao en poudre, soit le mettre partout si on veut pas s'embêter.
\section{Marbré}
\begin{recette}{Marbré}{5}{30min.+1 nuit}{30min.}
\begin{ingredients}
\ingredient 150g de beurre
\ingredient 300g de sucre
\ingredient 1 gousse de vanille, ou poudre de vanille, ou arome
\ingredient 2 oeufs
...
\etape rajouter la farine et la levure
\etape rajouter la crème liquide
...
\section{Pasteis de Nata}
\begin{recette}{Pasteis de Nata}{3}{30 min.+4h}{jaune d'oeufs}
\begin{ingredients}
\ingredient 1 pate feuilletée rectangulaire. 
\ingredient 310g de lait
\ingredient 35g de farine
\ingredient 200g de sucre
\ingredient 30g d'eau
\ingredient zeste de citron
\ingredient 4 jaunes d'oeufs
\end{ingredients}

\begin{remarque}
Ne pas mettre de cannelle dans la crème, c'est pas bon.
\end{remarque}


\begin{preparation}
\etape En théorie, pour le sirop de sucre, il faut mettre plus d'eau, puis faire réduire jusqu'à atteindre 106°C (pour une quantité initiale de 200g de sucre, et 135g d'eau, j'avais 228g de sirop à la fin)
\etape faites chauffer le sucre et l'eau, ne pas laisser bouillir afin de ne pas évaporer l'eau (sortir la casserole du feu puis remettre. Essayer de dissoudre le sucre au mieux. Versez dans le bol du robot puis faites chauffer le lait et la farine. 
\etape Dès que ça commence à épaissir, arrêter, et versez dans le bol du robot. Mélangez avec le fouet jusqu'à homogénéiser, puis laisser tiédir. 

\etape Préchauffez le four à 250°C chaleur tournante
\etape Occupez vous maintenant de la pâte feuilletée
\etape Badigeonner avec huile de tournesol aux doigts avant de rouler bien serré sur la longueur (la largeur fait 26cm dans mon cas). 
\etape Couper des tronçons de 2cm (13 tronçons dans mon cas).

Mettez les tronçons au frigo dans une assiette, et sortez les au fur et à mesure de la préparation pour qu'ils restent bien froids.
\etape Etalez les dans les moules. Pour cela, posez un tronçon sur la tranche au milieu du moule, avec deux ou trois doigts, appuyez pour aplatir sans chercher à ce que ce soit parfaitement uniforme. Puis toujours avec 2 doigts, appuyez successivement sur tout le pourtour pour relever la pâte jusqu'en haut du moule. Si un coté n'a pas assez de pâte, pendant ce processus, ça va soulever le pâte du fond, profitez en pour tirer un peu sur le bord d'en face pour récupérer un peu de pâte. 

\etape Ajoutez alors les jaunes dans la crème refroidie (en théorie, vers 37°C), puis versez dans les moules. 
\end{preparation}
\begin{cuisson}
Enfournez 16 minutes à 250°C
\end{cuisson}
\end{recette}

\section{Pavlova}
\begin{recette}{Pavlova}{3}{30 min.+4h}{}\index{blanc d'oeufs}
\begin{ingredients}
\ingredient[meringue]
...
\section{Tarte aux pommes façon tatie}
\begin{recette}{Tarte aux pommes façon tatie}{4}{1h}{40min.}\index{pommes}\index{tarte}
\begin{ingredients}
\ingredient 125g de farine
\ingredient 90g de sucre
\ingredient 60g d'huile de tournesol
\ingredient 90g de lait
\ingredient 2 oeufs
\ingredient 1 sachet de levure
\ingredient 4 pommes
\ingredient saupoudrer de cassonnade
\end{ingredients}

\begin{preparation}
\etape Ne préchauffez pas le four !
\etape Mélangez au fouet oeufs et sucre (la pâte est suffisamment liquide pour tout mélanger au fouet)
\etape Pelez et émincez les pommes
\etape Ajoutez dans la pâte la levure, la farine, l'huile et le lait. 
\etape Avec un sopalin, étalez un peu d'huile dans un plat à tarte, farinez
\etape Versez la pâte dans le plat à tarte. 
\etape Posez les lamelles de pommes très serrées, sans appuyer
\etape Saupoudrez de sucre et de canelle
\end{preparation}



\begin{cuisson}
Allumer le four à 170°C et enfournez pendant 42 minutes environ à 170°C (surveillez la cuisson à partir de 35 minutes et arrêtez quand c'est doré un peu partout (et pas juste à quelques endroits).
\end{cuisson}
\end{recette}
