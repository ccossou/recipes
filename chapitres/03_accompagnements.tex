...
\etape si la banane n'était pas assez mûre, n'est pas encore moelleuse mais déjà noire, enveloppez de papier alu et remettez sur la grille pour finir la cuisson à coeur et qu'elle soit moelleuse. 
\end{preparation}
\end{recette}
...
\begin{remarque}
Ne pas utiliser la chaleur pulsée, ça grille l'extérieur et l'intérieur est farineux. Il faut mieux four normal ou à chaleur tournante. 
\end{remarque}

\begin{cuisson}
Faites préchauffer le four à 200\degres C 10 minutes environ, puis enfournez-les à chaleur tournante :
\begin{itemize}
\item 45-60 minutes pour des patates assez grosses
\item 40-45 minutes si elles sont taillées assez fines façon frites
\end{itemize}
en les disposant dans un grand plat à tarte. Puis laissez reposer 20 minutes four éteint (et porte fermée pour ne pas faire partir la chaleur). 
\begin{remarque}
...
% J'ai mis 20 minutes à 120°C, et je laisse à cette température là tant que c'est pas moelleux (j'ai dû laisser 30 minutes de plus pour une partie des pommes de terre, avec chaleur tournante à 180°C initialement). 

% On doit pouvoir laisser à 70°C une fois cuit pour maintenir au chaud. 
...
\ingredient 740g/1080g/1200g d'eau (800g si à la casserole et non au cuiseur ; autre manière de faire, c'est même volume d'eau que de riz)
...
\begin{preparation}
\etape Pesez le sel dans le bac du cuiseur à riz
\etape Ajoutez l'eau pour dissoudre le sel dedans
\etape Ajoutez enfin le riz, puis faites en sorte qu'aucun grain de riz ne reste à la surface
